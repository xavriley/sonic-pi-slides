...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13100 = 0;while(true){
var m_13101 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13101 == null))
{} else
{m_13101.call(null);
if((count_13100 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13102 = (count_13100 + 1);
count_13100 = G__13102;
continue;
}
} else
{}
