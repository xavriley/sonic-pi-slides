...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t13106 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t13106 = (function (val,box,meta13107){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t13106.cljs$lang$type = true;
cljs.core.async.impl.channels.t13106.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t13106";
cljs.core.async.impl.channels.t13106.cljs$lang$ctorPrWriter = (function (this__4010__auto__,writer__4011__auto__,opt__4012__auto__){return cljs.core._write.call(null,writer__4011__auto__,"cljs.core.async.impl.channels/t13106");
});
cljs.core.async.impl.channels.t13106.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t13106.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13108){var self__ = this;
var _13108__$1 = this;return self__.meta13107;
});
cljs.core.async.impl.channels.t13106.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13108,meta13107__$1){var self__ = this;
var _13108__$1 = this;return (new cljs.core.async.impl.channels.t13106(self__.val,self__.box,meta13107__$1));
});
cljs.core.async.impl.channels.__GT_t13106 = (function __GT_t13106(val__$1,box__$1,meta13107){return (new cljs.core.async.impl.channels.t13106(val__$1,box__$1,meta13107));
});
}
return (new cljs.core.async.impl.channels.t13106(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_13109 = self__.takes.pop();if((taker_13109 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_13109))
{var take_cb_13110 = cljs.core.async.impl.protocols.commit.call(null,taker_13109);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_13110,taker_13109){
return (function (){return take_cb_13110.call(null,null);
});})(take_cb_13110,taker_13109))
);
} else
{}
{
