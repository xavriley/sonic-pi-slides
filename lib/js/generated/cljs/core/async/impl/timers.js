...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_13065 = 0;while(true){
if((i_13065 < arr.length))
{(arr[i_13065] = null);
{
...
{var i_13072 = (self__.level + 1);while(true){
if((i_13072 <= (new_level + 1)))
{(update[i_13072] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_13074 = 0;while(true){
if((i_13074 <= self__.level))
{var links_13075 = (update[i_13074]).forward;if(((links_13075[i_13074]) === x__$1))
{(links_13075[i_13074] = (x__$1.forward[i_13074]));
{
